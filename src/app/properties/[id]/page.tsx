            ...
            <div className="lg:col-span-1 relative">
                <div className="sticky top-24 space-y-6">
                    ...
                    <div className="bg-white rounded-3xl p-6 border border-slate-200/60 shadow-2xl shadow-slate-200/50">
                        ...
                        <Button 
                            asChild 
                            className="w-full mt-3 h-12 rounded-xl bg-[#25D366] hover:bg-[#20ba59] text-white font-bold shadow-md shadow-[#25D366]/20 border-none transition-all hover:scale-[1.02]"
                        >
                            <a 
                                href={`https://wa.me/?text=${encodeURIComponent(
                                    `🏠 *${property.title}*\n\n` +
                                    `💰 *Price:* ₹${(property.price || 0).toLocaleString('en-IN')}${property.listingFor === 'Rent' ? '/mo' : ''}\n` +
                                    `📍 *Location:* ${property.address}, ${property.city}\n` +
                                    `🏢 *Type:* ${property.propertyType} (${property.bhk || '-'})\n` +
                                    `🛋️ *Status:* ${property.furnishing || 'N/A'}\n\n` +
                                    `🔗 *View Photos & Details:* https://nestil.in/properties/${property.id}\n\n` +
